...
//import FingerTable.Finger;

//import node.heartBeatMonitor;
//import node.nodeListener;
//import node.nodeListener.TempHandler;
	...
	private class ConsoleHandler extends Thread {
		...
		public void countJoin(int nodeNum, long seed) throws UnknownHostException, IOException{
			...
			while(curNumNode < nodeNum){
				...
				node newNode = new node(nextNode, m, maxDelay, minDelay);
				newNode.start();
